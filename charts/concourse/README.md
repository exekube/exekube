...
echo -n "concourse" > basic-auth-username
openssl rand -base64 24 > basic-auth-password
```
...
pbpaste > postgresql-uri
# copy Github client id and secrets to clipboard and paste to files
pbpaste > github-auth-client-id
pbpaste > github-auth-client-secret
